  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.toolbar}>
        ...
        <select className={styles.select} value={folder} onChange={(e) => setFolder(e.target.value as 'all' | 'portraits' | 'gallery' | 'categories')}>
          <option value="all">All folders</option>
          <option value="portraits">Portraits</option>
          <option value="gallery">Gallery</option>
          <option value="categories">Categories</option>
        </select>
        <select className={styles.select} value={sortBy} onChange={(e) => setSortBy(e.target.value as 'newest' | 'name' | 'size')}>
